public class Motocicleta extends BaseVeiculosTerrestres {
    ...
    public Motocicleta(int codigo, String nome, String placa, String modelo, String cor, int eixos, double pesoLiquido,
            ...
            int anoFabricacao, int rodas, String chassi, String codigoRenavam, String tipoManete) {
    ...
    public void imprimir() {
        ...
        System.out.println("Tipo de Manete: " + this.tipoManete);
        System.out.println("");
    }
}