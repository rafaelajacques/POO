public class Caminhao extends BaseVeiculosTerrestres {
    ...
    public Caminhao(int codigo, String nome, String placa, String modelo, String cor, int eixos, double pesoLiquido,
            ...
            int anoFabricacao, int rodas, String chassi, String codigoRenavam, String tipoCarga, int portas) {
